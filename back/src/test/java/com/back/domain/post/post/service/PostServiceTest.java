...
class PostServiceTest {
    ...
    class CreatePostTest {
        ...
        void createPost_informationPost_success() {
            ...
            request.setTitle("제목");
            request.setPostType("INFORMATIONPOST");
        ...
        void createPost_practicePost_mentor_success() {
            ...
            PostCreateRequest request = new PostCreateRequest();
            request.setContent("실무내용");
            request.setTitle("실무경험");
            request.setPostType("PRACTICEPOST");
        ...
        void createPost_questionPost_initializeIsResolve() {
            ...
            Member member = MemberFixture.create(1L, "test@test.com", "Test User", "password", Member.Role.MENTEE);
            PostCreateRequest request = new PostCreateRequest();
            request.setContent("질문내용");
            request.setTitle("질문경험");
            request.setPostType("QUESTIONPOST");
        ...
        void createPost_invalidPostType_failure() {
            ...
            request.setContent("실무내용");
            request.setTitle("실무경험");
            request.setPostType("INVALIDPOST");
    ...
    class UpdatePostTest {
        ...
        void updatePost_author_success() {
            ...
            updateRequest.setTitle("새 제목");
            updateRequest.setContent("새 내용");
            updateRequest.setPostType("INFORMATIONPOST");
