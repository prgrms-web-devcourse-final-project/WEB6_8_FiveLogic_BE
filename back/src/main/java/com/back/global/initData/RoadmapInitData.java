...
public class RoadmapInitData {
    ...
    public void initTaskData() {
        ...
        taskService.createAlias(java, "JAVA");
    ...
    private void createJavaTraditionalRoadmap(Job backendJob) {
        // 샘플#1
        Member member = memberService.joinMentor("mentor1@test.com", "멘토#1", "test1", "1234", "백엔드 개발자", 3);
    ...
    private void createJavaModernRoadmap(Job backendJob) {
        // 샘플#2
        Member member = memberService.joinMentor("mentor2@test.com", "멘토#2", "test2", "1234", "백엔드 개발자", 5);
        Mentor mentor = updateMentorJob(member, backendJob);
    ...
    private void createJavaEnterpriseRoadmap(Job backendJob) {
        // 샘플#3
        Member member = memberService.joinMentor("mentor3@test.com", "멘토#3", "test3", "1234", "백엔드 개발자", 6);
        Mentor mentor = updateMentorJob(member, backendJob);
    ...
    private void createPythonDjangoRoadmap(Job backendJob) {
        // 샘플#4
        Member member = memberService.joinMentor("mentor4@test.com", "멘토#4", "test4", "1234", "백엔드 개발자", 4);
        Mentor mentor = updateMentorJob(member, backendJob);
    ...
    private void createNodeJSRoadmap(Job backendJob) {
        // 샘플#5
        Member member = memberService.joinMentor("mentor5@test.com", "멘토#5", "test5", "1234", "백엔드 개발자", 2);
        Mentor mentor = updateMentorJob(member, backendJob);
    ...
    private void createFullStackRoadmap(Job backendJob) {
        // 샘플#6
        Member member = memberService.joinMentor("mentor6@test.com", "멘토#6", "test6", "1234", "백엔드 개발자", 6);
        Mentor mentor = updateMentorJob(member, backendJob);
    ...
    private void createDevOpsRoadmap(Job backendJob) {
        // 샘플#7
        Member member = memberService.joinMentor("mentor7@test.com", "멘토#7", "test7", "1234", "백엔드 개발자", 7);
        Mentor mentor = updateMentorJob(member, backendJob);
