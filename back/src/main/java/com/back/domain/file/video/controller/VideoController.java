...
import com.back.domain.file.video.service.VideoManager;
...
public class VideoController {
    ...
    public RsData<UploadUrlGetResponse> getUploadUrl() {
        PresignedUrlResponse uploadUrl = videoManager.getUploadUrl();
    ...
    public RsData<UploadUrlGetResponse> getDownloadUrls(@RequestParam String objectKey) {
        PresignedUrlResponse downloadUrl = videoManager.getDownloadUrl(objectKey);
